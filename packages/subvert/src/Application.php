...
class Application extends Container
{
     ...
     * @return void
     */
    public function __construct($appName = null ,$basePath = null)
    {
    ...
    protected function bootstrapContainer()
    {
        ...
        $this->instance('Subvert\Framework\Application', $this);
    ...
    {
        return 'Subvert Based on Lumen (5.2.8) (Laravel Components 5.2.*)';
    }
